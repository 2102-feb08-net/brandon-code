...
namespace entity_framework_first_demo.Data
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Department", "EmployeeDBExercise");

                entity.HasIndex(e => e.DepartmentId, "UQ__Departme__B2079BEC6F8742F5")
                    .IsUnique();
            ...
            {
                entity.HasKey(e => e.EmpDetailsId)
                    .HasName("PK_EmpDetailsId");

                entity.ToTable("EmpDetails", "EmployeeDBExercise");

                entity.HasIndex(e => e.EmployeeId, "UQ__EmpDetai__7AD04F10B6542833")
                    .IsUnique();

                entity.HasIndex(e => e.EmpDetailsId, "UQ__EmpDetai__E1D1CEB5D6F358AC")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Employee)
                    .WithOne(p => p.EmpDetail)
                    .HasForeignKey<EmpDetail>(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<Employee1>(entity =>
            {
                ...
                entity.ToTable("Employee", "EmployeeDBExercise");

                entity.HasIndex(e => e.EmployeeId, "UQ__Employee__7AD04F1070FE5630")
                    .IsUnique();

                entity.HasIndex(e => e.Ssn, "UQ__Employee__CA1E8E3CFC757CD6")
                    .IsUnique();
